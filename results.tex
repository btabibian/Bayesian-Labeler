...
In conclusion, The analysis given above can be summarized in Figure \ref{fig:plot}. Line segment with large slops indicate that user performance has change dramatically from one experiment to the other.

\begin{figure}[t]
\centering
\includegraphics[width=9cm]{obs_sec.png}
